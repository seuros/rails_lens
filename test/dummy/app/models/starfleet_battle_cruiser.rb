...
# Type Value: StarfleetBattleCruiser
# Sibling Classes: CargoVessel
#
...
# - battle_status: { standby: "standby", yellow_alert: "yellow_alert", red_alert: "red_alert", battle_stations: "battle_stations" } (string)
#
# == Notes
