...
#
# notes = ["sequence:NOT_NULL", "coordinates:NOT_NULL", "eta:NOT_NULL", "notes:NOT_NULL", "waypoint_type:NOT_NULL", "status:NOT_NULL", "status:DEFAULT", "coordinates:LIMIT", "waypoint_type:INDEX", "status:INDEX", "notes:STORAGE"]
